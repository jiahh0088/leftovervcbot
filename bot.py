...
async def help_ui(ctx):
    ...
    embed.add_field(name=f"`{prefix}leaderboard`", value="Display the current individual activity rankings.", inline=False)
    embed.add_field(name=f"`{prefix}fgleaderboard`", value="Display the current group standing data.", inline=False)
...
async def on_message(message):
    ...
    # Check if the message is a command to prevent adding text activity points for bot configurations
